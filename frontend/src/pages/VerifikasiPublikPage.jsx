    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-900 via-primary-800 to-emerald-700 flex items-center justify-center p-4">
      ...
      >
          ...
          <div className="bg-white rounded-3xl p-10 text-center shadow-2xl">
            ...
            <div className="mt-6 p-4 bg-red-50 rounded-xl">
              <p className="text-xs text-red-600">
                ⚠️ Dokumen ini tidak dapat diverifikasi keasliannya melalui sistem MUSLIMA.
              </p>
            </div>
          </div>
        ) : (
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="border-t border-gray-100 pt-4">
                <div className="flex items-center gap-2 text-xs text-gray-400">
                  ...
                  <p>Diverifikasi oleh Manajemen Surat dan Layanan Informasi Muslimat (MUSLIMA)</p>
                </div>
        ...
        <p className="text-center text-primary-200 text-xs mt-4">
          MUSLIMA — Manajemen Surat dan Layanan Informasi Muslimat
        </p>
      </motion.div>
    </div>
  )
